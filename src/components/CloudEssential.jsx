  ...
  const credentials = [
    {
      ...
      image: "/cloud practitioner.jpg", // Replace with your real asset path
      pdfUrl: "/aws essential practitioner.pdf",
    },
    {
      ...
      date: "Issued May 2026",
      image: "/quest.jpg", 
      pdfUrl: "/AWS cloud quest practitioner.pdf",
    }
  ];

  return (
    <section id="cloud-essential" className="py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800/50 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto min-w-0 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4 px-1">
          <div className="space-y-3">
            ...
            >
              AWS Cloud Practitioner Completion Certificates
            </motion.h2>
          </div>
        ...
        {/* Isolated Horizontal Scrollable Track - Adjusted to match the smaller size limit */}
        <div className="flex gap-6 overflow-x-auto pb-8 pt-2 px-1 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-800 scrollbar-track-transparent min-w-0 w-full">
          {credentials.map((cert, idx) => (
            ...
            >
              {/* Scaled Down Certificate Image Frame (A4 Aspect Preserved) */}
